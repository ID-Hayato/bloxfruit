<x-admin-layout>
    <div class="w-full">
        ...
        @endif
        <form action="{{ route('gun.update', $gun) }}" method="post">
            @csrf
            ...
            <div class="border-b-2 w-full mb-2">
                ...
                <div class="text-center mb-3">
                    <input type="text" name="name" class="w-2/4" value="{{ $gun->name }}">
                </div>
            </div>
                ...
                <div class="text-center mb-3">
                    <label>
                        <select name="skill_z_id" class="w-1/5">
                            <option value="{{ $gun->skill_z_id }}">
                                {{ $skills->firstWhere('id', $gun->skill_z_id)->common_name }}
                            <option>
            ...
            <div class="border-b-2 w-full mb-2">
                ...
                <div class="text-center mb-3">
                    <input type="number" name="skill_z_mastery" class="w-1/8" value="{{ $gun->skill_z_mastery }}">
                </div>
            </div>
            <div class=" w-full mb-2">
                ...
                <div class="text-center mb-3">
                    <label>
                        <select name="skill_x_id" class="w-1/5">
                            <option value="{{ $gun->skill_x_id }}">
                                {{ $skills->firstWhere('id', $gun->skill_x_id)->common_name }}</option>
                            @foreach ($skills as $skill)
                                <option value="{{ $skill->id }}">{{ $skill->common_name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="border-b-2 w-full mb-2">
                ...
                <div class="text-center mb-3">
                    <input type="number" name="skill_x_mastery" class="w-1/8" value="{{ $gun->skill_x_mastery }}">
                </div>
            </div>
            <div class="border-b-2 w-full mb-2">
            ...
            <div class="border-b-2 w-full mb-2">
                ...
                <div class="text-center mb-3">
                    <textarea name="howtogetit" class="w-3/4" id="" cols="30" rows="10" value="">{{ $gun->howtogetit }}</textarea>
                </div>
            </div>
